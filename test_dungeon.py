...
for down in range(zwidth-1):
    ...
    with open('dungeon_' + str(down+1) + '.html','w') as f:
        ...
        if len(wandering_monster_stack) > 0:
            ...
            dfsub = pd.DataFrame()                                                   
            dfsub['total_treasure_copper'] = [total_treasure['copper']]
            dfsub['total_treasure_silver'] = [total_treasure['silver']]
            dfsub['total_treasure_electrum'] = [total_treasure['electrum']]
            dfsub['total_treasure_gold'] = [total_treasure['gold']]
            dfsub['total_treasure_platinum'] = [total_treasure['platinum']]
            dfsub['total_treasure_gems'] = [total_treasure['gems']]
            dfsub['total_treasure_jewellery'] = [total_treasure['jewellery']]
            dfsub['total_treasure_magic'] = [total_treasure['magic']]
            dfsub['total_treasure_monster_copper'] = [total_treasure_monster['copper']]
            dfsub['total_treasure_monster_silver'] = [total_treasure_monster['silver']]
            dfsub['total_treasure_monster_electrum'] = [total_treasure_monster['electrum']]
            dfsub['total_treasure_monster_gold'] = [total_treasure_monster['gold']]
            dfsub['total_treasure_monster_platinum'] = [total_treasure_monster['platinum']]
            dfsub['total_treasure_monster_gems'] = [total_treasure_monster['gems']]
            dfsub['total_treasure_monster_jewellery'] = [total_treasure_monster['jewellery']]
            dfsub['total_treasure_monster_magic'] = [total_treasure_monster['magic']]
            dfsub['wm_total_treasure_copper'] = [wm_total_treasure['copper']]
            dfsub['wm_total_treasure_silver'] = [wm_total_treasure['silver']]
            dfsub['wm_total_treasure_electrum'] = [wm_total_treasure['electrum']]
            dfsub['wm_total_treasure_gold'] = [wm_total_treasure['gold']]
            dfsub['wm_total_treasure_platinum'] = [wm_total_treasure['platinum']]
            dfsub['wm_total_treasure_gems'] = [wm_total_treasure['gems']]
            dfsub['wm_total_treasure_jewellery'] = [wm_total_treasure['jewellery']]
            dfsub['wm_total_treasure_magic'] = [wm_total_treasure['magic']]
