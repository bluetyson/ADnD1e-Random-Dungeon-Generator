...
if __name__ == '__main__':
    ...
    with concurrent.futures.ProcessPoolExecutor(mp_context=ctx) as executor:
        future_to_data = {executor.submit(dungeon_sim, idx, pc_list[idx], verbosity_list[idx], usepath_list[idx], rooms_check_list[idx], levels_check_list[idx]): idx for idx in idx_list}		
